        ...
        <div class="panel-body">
          <form role="form" method="post" id="changeme-form">
            <fieldset>
              ...
              <div class="form-group">
                <label for="book-amount" class="col-md-2 control-label" style="margin-top: 0;">Order Status</label>
                <div class="col-md-10">
                  <input class="form-control" placeholder="Amount" type="text" value='{{printf "%s" .order.Status}}' id="book-amount" disabled>
                </div>
              </div>
